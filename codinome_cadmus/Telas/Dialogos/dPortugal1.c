...
int dPortugal1(Controle* controle, ALLEGRO_DISPLAY* display, ALLEGRO_EVENT_QUEUE* event_queue) {
	int screen_w = 1280;
	int screen_h = 720;
	...
	montadorDeObjeto(dialogo, screen_h, screen_w, 40, 0, "Auxiliar/caixasDeTexto/portugal1.png");
